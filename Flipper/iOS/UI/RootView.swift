...
public struct RootView: View {
    ...
    public var body: some View {
        RootViewImpl()
            // Nikita is a dark, magenta-on-purple app (like nikita-qflipper),
            // so pin the whole UI to dark regardless of the system setting --
            // the custom palette and text colors are tuned for a dark base.
